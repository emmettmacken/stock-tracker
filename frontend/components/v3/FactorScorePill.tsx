...
function colorClass(score: number, size: "sm" | "md") {
  const base = size === "md"
    ? "inline-flex items-center justify-center rounded-full border text-sm font-bold w-10 h-10 tabular-nums"
    : "inline-flex items-center justify-center rounded-md px-1.5 py-0.5 text-[11px] font-bold border tabular-nums";
